        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?=Html::a('add',['balance/create'],['class'=>'btn btn-sm btn-primary'])?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
    ...
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
     <?=
        ...
        'columns' =>[
            ...
            'buttons'=>[
                'view'=>function ($url) {
                    return Html::a('invoice', $url, ['class' => 'glyphicon glyphicon-credit-card btn btn-default btn-xs custom_button']);
                },
                'update'=>function ($url) {
